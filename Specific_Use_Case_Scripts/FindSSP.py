...
This will EXCLUDE 
    ...
    ...peptides which have an early truncation, with or without SSP
...
dfsalty = pd.read_csv(r"Hardcodedpath\SALTY_TrypticPeptides.tsv", sep='\t',usecols=['Base Sequence'])
dfecoli = pd.read_csv(r"Hardcodedpath\Ecoli_tryptic_peptides.tsv", sep='\t',usecols=['Base Sequence'])
...
#%%
#Export tables
dffrac.to_csv(r'Hardcodedpath\Ecoli_v_Salty_Similarity_Summary.csv')
dfsalty.to_csv(r'Hardcodedpath\All_SALTY_to_ECOLI.csv')
dfecoli.to_csv(r'Hardcodedpath\All_ECOLI_to_SALTY.csv')

dff = dfsalty[dfsalty['Is SSP']]
dff.rename({'Base Sequence':'SALTY Sequence'})
dff.to_csv(r'Hardcodedpath\SSP_SALTY_to_ECOLI.csv')

dff = dfecoli[dfecoli['Is SSP']]
dff.rename({'Base Sequence':'ECOLI Sequence'})
dff.to_csv(r'Hardcodedpath\SSP_ECOLI_to_SALTY.csv')

dff = dfsalty[dfsalty['Is DSP']]
dff.rename({'Base Sequence':'SALTY Sequence'})
dff.to_csv(r'Hardcodedpath\DSP_SALTY_to_ECOLI.csv')

dff = dfecoli[dfecoli['Is DSP']]
dff.rename({'Base Sequence':'ECOLI Sequence'})
dff.to_csv(r'Hardcodedpath\DSP_ECOLI_to_SALTY.csv')
