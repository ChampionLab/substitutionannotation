...
to eventually look at technical reproducability for all peptides

~~still needs a properly formatted input file~~
...
dfSubs = pd.read_csv(os.path.join(p.outputdir,'Peptide Quant Tech.csv'))
